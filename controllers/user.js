...
import {registerNewUser, loginUser, logoutUser, updateUser} from '../services/user.js';
...
export const register = async (req, res, next) => {
    ...
    try {
        ...
        if (!user) {
            throw createError(409, 'Such email has already exist! Try another one, please!');
        }
...
//         await RevokedToken.create({token, _id})
